...
namespace MyCompany.Security
{
    ...
    public class EventTrackerBase
    {
        ...
        private static Regex _modifiedOnRegex = new Regex("ModifiedOn|updated|update_date|updated_date", RegexOptions.IgnoreCase);
        ...
        private static Regex _createdOnRegex = new Regex("CreatedOn|create_date|created_by", RegexOptions.IgnoreCase);
